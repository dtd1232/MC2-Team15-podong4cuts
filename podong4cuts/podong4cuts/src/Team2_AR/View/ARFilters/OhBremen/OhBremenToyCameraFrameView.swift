...
struct OhBremenToyCameraFrameView: View {
    // cameraview ui
    ...
    var arViewContainer = OhBremenToyARView()
...
struct OhBremenToyCameraFrameViewPreview: PreviewProvider {
