...
struct SpaceWalkSpaceCameraFrameView: View {
    ...
    var arViewContainer = SpaceWalkSpaceARView()
...
struct SpaeceWalkSpaceCameraFrameViewPreview: PreviewProvider {
